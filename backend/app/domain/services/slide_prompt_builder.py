...
<CONTRAINTES>
- Réponds UNIQUEMENT avec le contenu de la slide en Markdown pur (en insérant au maximum 5 emojis pour tout le contenu si cela est pertinent)
...
- Le contenu dans slide_content doit être du Markdown pur (en insérant au maximum 5 emojis pour tout le contenu si cela est pertinent)
...
<CONTRAINTES>
- Réponds UNIQUEMENT avec le texte d'introduction (pas de Markdown) (en insérant au maximum 5 emojis pour tout le contenu si cela est pertinent)
